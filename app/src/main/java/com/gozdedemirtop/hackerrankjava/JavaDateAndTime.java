...
For example, if you are given the date August 14th 2017,
the method should return MONDAY as the day on that date.

Input Format

A single line of input containing
the space separated month, day and year, respectively, in  MM DD YY  format.
...
class Result {
    ...
    public static String findDay(int month, int day, int year) {
        ...
        String[] day_of_week = {"SUNDAY", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY",
        "FRIDAY","SATURDAY"};

        return day_of_week[calendar.get(Calendar.DAY_OF_WEEK)-1];


        // Feature of JAVA 8, Note: import java.time.LocalDate;
